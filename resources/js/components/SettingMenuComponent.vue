            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-if="ShowForm" class="w-100 edit-form">
                            ...
                            <div class="form w-100">
                                <form class="d-flex justify-content-center w-100 p-2" v-for="item in itemToEdit">
                                    <div class="form-group w-100 d-flex flex-column align-items-center">
                                        <input type="hidden" :value="item.id" id="item-id">
                                        <input type="text" class="form-control w-75 rounded-0 border-secondary" :value="item.item_name" id="item-name">
                                        <input type="text" class=" mt-2 form-control w-75 rounded-0 border-secondary" :value="item.item_price" id="item-price">
                                    </div>
                                    <div class="form-group w-100 d-flex flex-column align-items-center">
                                        <input type="text" class="form-control w-75 rounded-0 border-secondary" :value="item.item_desc" id="item-desc">
                                        <input type="text" class=" mt-2 form-control w-75 rounded-0 border-secondary">
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button @click="updatedItem" type="button" class="btn btn-primary rounded-0">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
